...
const basePath = '/kolo-mee-stinablis-1775102286256';
...
export default function Home() {
  ...
  const products = [{ n: 'Product 1', d: 'Description', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+1', icon: 'domain' }, { n: 'Product 2', d: 'Description', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+2', icon: 'architecture' }, { n: 'Product 3', d: 'Description', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+3', icon: 'chair' }, { n: 'Product 4', d: 'Description', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+4', icon: 'eco' }, { n: 'Product 5', d: 'Description', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+5', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1486325212027-8081e485255e?w=1920&q=80" alt="Hero" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">Our vision</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">Our mission</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">haha</h4>
                  <p className="text-sm text-on-surface-variant">Our commitment to integrity</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">lmao</h4>
                  <p className="text-sm text-on-surface-variant">Our dedication to innovation</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://placehold.co/600x400/e2e8f0/64748b?text=About+1" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://placehold.co/600x400/e2e8f0/64748b?text=About+2" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://placehold.co/600x400/e2e8f0/64748b?text=About+3" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
